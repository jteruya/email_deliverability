...
dailydigest_clicked_options = {
  chart: {
    renderTo: 'dailydigest_clicked',
    type: 'spline',
    zoomType: 'x',
    height: 350,
    borderWidth: 1
  ...
  title: {
    text: 'Daily Digest Percentage Clicked'
  },
  tooltip: {
    formatter: function () {
...
$.get('csv/dailydigestemailclicked.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    if (lineNo == linecnt) {
      ...
      dailydigest_clicked_options.series.push(series)
    }
  })

dailydigest_clicked = new Highcharts.Chart(dailydigest_clicked_options);
