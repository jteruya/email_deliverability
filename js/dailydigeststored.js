...
dailydigest_stored_options = {
  chart: {
    renderTo: 'dailydigest_stored',
    type: 'spline',
    zoomType: 'x',
    height: 350,
    borderWidth: 1
  ...
  title: {
    text: 'Daily Digest Percentage Stored'
  },
  tooltip: {
    formatter: function () {
...
$.get('csv/dailydigestemailstored.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    if (lineNo == linecnt) {
      ...
      dailydigest_stored_options.series.push(series)
    }
  })

dailydigest_stored = new Highcharts.Chart(dailydigest_stored_options);
