...
dailydigest_complained_options = {
  chart: {
    renderTo: 'dailydigest_complained',
    type: 'spline',
    zoomType: 'x',
    height: 350,
    borderWidth: 1
  ...
  title: {
    text: 'Daily Digest Percentage Complained'
  },
  tooltip: {
    formatter: function () {
...
$.get('csv/dailydigestemailcomplained.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    if (lineNo == linecnt) {
      ...
      dailydigest_complained_options.series.push(series)
    }
  })

dailydigest_complained = new Highcharts.Chart(dailydigest_complained_options);
