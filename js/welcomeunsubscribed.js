...
welcome_unsubscribed_options = {
  chart: {
    renderTo: 'welcome_unsubscribed',
    type: 'spline',
    zoomType: 'x',
    height: 350,
    borderWidth: 1
  ...
  title: {
    text: 'Welcome Email Percentage Unsubscribed'
  },
  tooltip: {
    formatter: function () {
...
$.get('csv/welcomeemailunsubscribed.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    if (lineNo == linecnt) {
      ...
      welcome_unsubscribed_options.series.push(series)
    }
  })

welcome_unsubscribed = new Highcharts.Chart(welcome_unsubscribed_options);
