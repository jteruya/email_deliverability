...
dailydigest_unsubscribed_options = {
  chart: {
    renderTo: 'dailydigest_unsubscribed',
    type: 'spline',
    zoomType: 'x',
    height: 350,
    borderWidth: 1
  ...
  title: {
    text: 'Daily Digest Percentage Unsubscribed'
  },
  tooltip: {
    formatter: function () {
...
$.get('csv/dailydigestemailunsubscribed.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    if (lineNo == linecnt) {
      ...
      dailydigest_unsubscribed_options.series.push(series)
    }
  })

dailydigest_unsubscribed = new Highcharts.Chart(dailydigest_unsubscribed_options);
