...
welcome_opened_options = {
  chart: {
    renderTo: 'welcome_opened',
    type: 'spline',
    zoomType: 'x',
    height: 350,
    borderWidth: 1
  ...
  title: {
    text: 'Welcome Email Percentage Opened'
  },
  tooltip: {
    formatter: function () {
...
$.get('csv/welcomeemailopened.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    if (lineNo == linecnt) {
      ...
      welcome_opened_options.series.push(series)
    }
  })

welcome_opened = new Highcharts.Chart(welcome_opened_options);
