...
percent_opened_options = {
  chart: {
    renderTo: 'percent_opened',
    type: 'spline',
    zoomType: 'x',
    height: 350,
    borderWidth: 1
...
$.get('csv/percentemailedopened.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    if (lineNo == linecnt) {
      ...
      percent_opened_options.series.push(series)
    }
  })

percent_opened = new Highcharts.Chart(percent_opened_options);
