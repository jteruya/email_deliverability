...
percent_clicked_options = {
  chart: {
    renderTo: 'percent_clicked',
    type: 'spline',
    zoomType: 'x',
    height: 350,
    borderWidth: 1
...
$.get('csv/percentemailedclicked.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    if (lineNo == linecnt) {
      ...
      percent_clicked_options.series.push(series)
    }
  })

percent_clicked = new Highcharts.Chart(percent_clicked_options);
