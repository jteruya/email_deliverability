...
welcome_stored_options = {
  chart: {
    renderTo: 'welcome_stored',
    type: 'spline',
    zoomType: 'x',
    height: 350,
    borderWidth: 1
  ...
  title: {
    text: 'Welcome Email Percentage Stored'
  },
  tooltip: {
    formatter: function () {
...
$.get('csv/welcomeemailstored.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    if (lineNo == linecnt) {
      ...
      welcome_stored_options.series.push(series)
    }
  })

welcome_stored = new Highcharts.Chart(welcome_stored_options);
