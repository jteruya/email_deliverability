...
welcome_complained_options = {
  chart: {
    renderTo: 'welcome_complained',
    type: 'spline',
    zoomType: 'x',
    height: 350,
    borderWidth: 1
  ...
  title: {
    text: 'Welcome Email Percentage Complained'
  },
  tooltip: {
    formatter: function () {
...
$.get('csv/welcomeemailcomplained.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    if (lineNo == linecnt) {
      ...
      welcome_complained_options.series.push(series)
    }
  })

welcome_complained = new Highcharts.Chart(welcome_complained_options);
